...
class Peer extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $last_flap_ns = 0;
    /**
     *The last ping payload the peer has sent to us.
     *
     * Generated from protobuf field <code>bytes last_ping_payload = 15;</code>
     */
    protected $last_ping_payload = '';
     ...
     *           Features advertised by the remote peer in their init message.
     *     @type array<\Lnrpc\TimestampedError>|\Google\Protobuf\Internal\RepeatedField $errors
     *          The latest errors received from our peer with timestamps, limited to the 10
     *          most recent errors. These errors are tracked across peer connections, but
     *          are not persisted across lnd restarts. Note that these errors are only
     *          stored for peers that we have channels open with, to prevent peers from
     ...
     *
     * Generated from protobuf field <code>repeated .lnrpc.TimestampedError errors = 12;</code>
     * @param array<\Lnrpc\TimestampedError>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     * @return string
     */
    public function getLastPingPayload()
    {
        return $this->last_ping_payload;
    }
     ...
     * @return $this
     */
    public function setLastPingPayload($var)
    {
        GPBUtil::checkString($var, False);
        $this->last_ping_payload = $var;
