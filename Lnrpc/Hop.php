...
class Hop extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool tlv_payload = 9 [deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>bytes metadata = 13;</code>
     */
    protected $metadata = '';
    ...
    {
        @trigger_error('chan_capacity is deprecated.', E_USER_DEPRECATED);
    ...
    {
        @trigger_error('amt_to_forward is deprecated.', E_USER_DEPRECATED);
    ...
    {
        @trigger_error('tlv_payload is deprecated.', E_USER_DEPRECATED);
    ...
    public function hasAmpRecord()
    {
        return isset($this->amp_record);
    }

    public function clearAmpRecord()
    {
        unset($this->amp_record);
    }
