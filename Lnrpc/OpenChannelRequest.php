...
class OpenChannelRequest extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $max_local_csv = 0;
    /**
     *The explicit commitment type to use. Note this field will only be used if
     *the remote peer supports explicit channel negotiation.
     *
     * Generated from protobuf field <code>.lnrpc.CommitmentType commitment_type = 18;</code>
     */
    protected $commitment_type = 0;
    /**
     *If this is true, then a zero-conf channel open will be attempted.
     *
     * Generated from protobuf field <code>bool zero_conf = 19;</code>
     */
    ...
    {
        @trigger_error('node_pubkey_string is deprecated.', E_USER_DEPRECATED);
     ...
     * @return bool
     */
    public function getScidAlias()
    {
        return $this->scid_alias;
    }
     ...
     * @return $this
     */
    public function setScidAlias($var)
    {
        GPBUtil::checkBool($var);
        $this->scid_alias = $var;
