...
class PendingChannel extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>int64 num_forwarding_packages = 10;</code>
     */
    protected $num_forwarding_packages = 0;
    /**
     * A set of flags showing the current state of the channel.
     *
     * Generated from protobuf field <code>string chan_status_flags = 11;</code>
     */
     ...
     *           The commitment type used by this channel.
     *     @type int|string $num_forwarding_packages
     *           Total number of forwarding packages created in this channel.
     ...
     * @return int|string
     */
    public function getNumForwardingPackages()
    {
        return $this->num_forwarding_packages;
    }
     ...
     * @return $this
     */
    public function setNumForwardingPackages($var)
    {
        GPBUtil::checkInt64($var);
        $this->num_forwarding_packages = $var;
