...
class ForwardingHistoryResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Lnrpc\ForwardingEvent>|\Google\Protobuf\Internal\RepeatedField $forwarding_events
     *           A list of forwarding events from the time slice of the time series
     *           specified in the request.
     ...
     *
     * Generated from protobuf field <code>repeated .lnrpc.ForwardingEvent forwarding_events = 1;</code>
     * @param array<\Lnrpc\ForwardingEvent>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
